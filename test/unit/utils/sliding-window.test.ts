...
describe('SlidingWindowManager', () => {
    ...
    it('should add values to the sliding window', () => {
        const slidingWindowManager = SlidingWindowManager.create(3, 0)
        ...
        expect(slidingWindowManager.getAverage()).to.equal(20)
    })
    ...
    it('should remove the oldest element when the window is full', () => {
        ...
        expect(slidingWindowManager.getAverage()).to.equal(30)
    })
    it('should bundle the elements up', () => {
        const slidingWindowManager = SlidingWindowManager.create(10, 0)
        ...
        expect(slidingWindowManager.getAverage()).to.equal(10)
    ...
    it('should delete the largest element when we have too many elements', () => {
        const slidingWindowManager = SlidingWindowManager.create(20, 0)
